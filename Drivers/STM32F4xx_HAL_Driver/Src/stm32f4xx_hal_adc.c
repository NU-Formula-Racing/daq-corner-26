  ...
  ******************************************************************************
  ...
  (#) ADC driver can be used among three modes: polling, interruption,
     ...
     *** DMA mode IO operation ***
     ==============================
     [..]
       (+) Start the ADC peripheral using HAL_ADC_Start_DMA(), at this stage the user specify the
  length of data to be transferred at each end of conversion
       (+) At The end of data transfer by HAL_ADC_ConvCpltCallback() function is executed and user
  can add his own code by customization of function pointer HAL_ADC_ConvCpltCallback
     ...
     *** ADC HAL driver macros list ***
     ...
     [..]
      ...
      (+) __HAL_ADC_GET_IT_SOURCE: Check if the specified ADC interrupt source is enabled or
  disabled
